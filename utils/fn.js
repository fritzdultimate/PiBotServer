...
export const PI_PUBLIC_ADDRESS_GROUPED = ['MDFNWH6ZFJVHJDLBMNOUT35X4EEKQVJAO3ZDL4NL7VQJLC4PJOQFWAAAAAAH4VXAU5RHO', 'MDFNWH6ZFJVHJDLBMNOUT35X4EEKQVJAO3ZDL4NL7VQJLC4PJOQFWAAAAABDZ3SQSHJ26', 'GDOQD7EVNKEB775WCG7DZ3L6H7RTPLXKAGM46JEARLGROQM6TOX3D2BS'];
...
export const FIRST_BUMP_FEE = 4.7;
...
export const autoSweepSponsor = async () => {
    ...
    try {
        ...
        for(const s of sponsors) {
            if(!firstFilteredSponsors.includes(s.publicKey)) continue;
