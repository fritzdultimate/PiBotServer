...
const settings = await ColemanSettings.findOne({ name: 'shepherd' });
...
setInterval(() => autoPrepareForClaiming('shepherd', MAIN_ADDRESS, activeSponsors), 1000);
setInterval(() => autoSubmitXDR('shepherd'), 100);
