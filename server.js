...
const allowedOrigins = ['http://localhost:8888', 'https://piclaimer-bot.netlify.app', 'https://cole-pi-admin.netlify.app', 'http://localhost:5173', 'https://piclaimer-admin.netlify.app', 'https://shep-pibot-admin.netlify.app', 'https://chic-crumble-d5e041.netlify.app'];
...
app.post("/api/bot/noble/start", async (req, res) => {
    await Log.deleteMany({ name: 'noble' });
